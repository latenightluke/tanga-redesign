...
class ProductPage extends Component {
  ...
  render() {
    const quantityBoxClasses =
      "py-2 px-6 rounded-sm border-2 border-gray-300 text-gray-500 hover:text-gray-500 hover:border-gray-600";
    const activeClass = "text-gray-800 border-2 border-red-600";
        ...
        <div className="row">
          <div className="col-1">
            <img
              ...
              src="https://tanga3.imgix.net/https%3A%2F%2Fs3.amazonaws.com%2Ftanga-images%2F91357a09dda6.jpeg?ixlib=rails-2.1.1&w=1270&h=1270&auto=format%2Ccompress&cs=srgb&s=97a76e5018c3d6dec978be55362fa5e9"
              alt=""
            />
            <img
          ...
          <div className="col-3">
            <h4 className="text-charcoal fw-600 mb-0">
              Parrot Rolling Spider Helicopter with HD Camera - Plus Free
              Express Shipping
            </h4>
            <p className="mb-4">
            ...
            <div>
              ...
              <span className="text-gray fs-xs ml-1 mb-0 d-inline-block font-normal">
                <s>$34.99</s>
              </span>
            </div>
