  ...
  render() {
    return (
      <div>
        <NavLink
          to="/blog"
          className="block border-b-2 border-gray-100"
          style={{ overflow: "hidden" }}
        >
          <img src={ChannelHeaderTwo} className="img-fluid" alt="" />
        </NavLink>
        <div className="p-3 md:p-5 border-t-2 border-white">
          <Section name="Featured Deals">
            <ProductCard
              ...
              name={
                'Apple 13.3" MacBook Pro MD101LL/A + FREE CASE (Core i5, 4GB, 500GB HDD)'
              }
              price="$549.23"
