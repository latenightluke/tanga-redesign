    ...
    return (
      <div>
        <Container
          fluid
          className={
            styles.footer + ' bg-white bt-2-fog py-3 py-md-5 px-3 px-md-5 fs-xs'
          }
        >
          <div className="row">
            <div className="col-12 col-md-3">
              ...
              <ul className="list-style-none">
                ...
                <li>
                  <a href="">Why Trust Tanga?</a>
                </li>
                <li>
                  <a href="">Meet The Team</a>
                </li>
                <li>
                  <a href="">How Tanga Works</a>
                </li>
                <li>
                  <a href="">About Our Deals</a>
                </li>
                <li>
        ...
        <Container
          ...
          className={
            styles.footerBanner +
            ' bg-black d-flex justify-content-between px-5 py-2'
          }
        >
