      ...
      <div className="fixed-top">
        <div>
          ...
          <div className="container-fluid bg-red align-items-center px-md-4 px-3 py-2 d-flex flex-row justify-content-between text-center text-md-left">
            <NavLink
              to="/"
              className="d-inline-flex mr-auto text-center text-md-left"
            >
            ...
            <div
              className={
                styles.search +
                ' d-flex mx-auto justify-content-center justify-self-center align-self-center'
              }
            ...
            <div className="align-self-center d-none d-md-flex">
              <a
                href=""
                className="text-white pl-4 d-flex align-items-center align-content-center"
              >
                <FontAwesomeIcon
                  icon="question-circle"
                  className="mr-2 mb-1 fs-sm"
                />
