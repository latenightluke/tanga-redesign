    ...
    return (
      <div className={styles.nav}>
        <div className={styles.navContainer + ' bg-white'}>
          <NavLink
            to="/"
            className="bg-white p-4 d-block bb-1-cloud text-center"
          >
            <img src={logo} className="img-fluid mx-auto" alt="Tanga" />
            <p className="mb-0 fs-14 text-charcoal text-center fw-regular">
              Pattern Library
            </p>
          </NavLink>
          ...
          <div id="accordion" role="tablist" aria-multiselectable="true">
            <div>
              <div role="tab" id="headingOne">
                <a
                  className="px-4 py-3 d-block bg-white bb-1-cloud fw-6"
            ...
            <div>
              <div role="tab" id="headingTwo">
                <a
                  className="collapsed px-4 py-3 d-block bg-white bb-1-cloud fw-6"
                  style={{ position: 'relative' }}
                  data-toggle="collapse"
                  data-parent="#accordion"
                  href="#collapseTwo"
